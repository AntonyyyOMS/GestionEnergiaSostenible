...
// import java.util.Date; // No es necesario si no usas JDateChooser y conviertes directamente LocalDate a String
...
public class ModuloRegistroConsumoGUI extends JPanel {
    ...
    private JTextField txtFecha; // Usaremos JTextField para la fecha
    ...
    return tablaHistorialConsumo; // Reemplaza con el nombre de tu JTable
}
    ...
    private void initComponents() {
        ...
        txtFecha = new JTextField(15); // JTextField para la fecha
    ...
    private void addListeners() {
        ...
        tablaHistorialConsumo.getSelectionModel().addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting() && tablaHistorialConsumo.getSelectedRow() != -1) {
                ...
                String fechaStr = tableModel.getValueAt(selectedRow, 1).toString();
                txtFecha.setText(fechaStr); // Directamente al JTextField
