...
public class ProyectoEnergia implements Cloneable {
    ...
    private String tipoFuente;  // Ahora se inicializa en el constructor
    private double capacidadMW;

    public ProyectoEnergia() {
    }

    // Constructor que recibe el tipo de fuente
    ...
    public double getCapacidadMW() {
        return capacidadMW;
    }

    public void setCapacidadMW(double capacidadMW) {
        this.capacidadMW = capacidadMW;
    }
